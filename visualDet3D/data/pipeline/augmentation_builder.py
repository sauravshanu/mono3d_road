...
class Compose(object):
    ...
    def __call__(self, left_image:np.ndarray,
                       ...
                       road_map:Union[None, np.ndarray]=None)->List[Union[None, np.ndarray, List[KittiObj]]]:
        """
        ...
        for t in self.transforms:
            left_image, right_image, p2, p3, labels, image_gt, lidar, road_map  = t(left_image, right_image, p2, p3, labels, image_gt, lidar, road_map)
        return_list = [left_image, right_image, p2, p3, labels, image_gt, lidar, road_map]
        if self.is_return_all:
            return return_list
