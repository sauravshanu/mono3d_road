...
class ConvertToFloat(object):
    ...
    """
    def __call__(self, left_image, right_image=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None, road_map=None):
        return left_image.astype(np.float32), right_image if right_image is None else right_image.astype(np.float32), p2, p3, labels, image_gt, lidar, road_map
...
class Normalize(object):
    ...
    def __call__(self, left_image, right_image=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None, road_map=None):
        ...
        if right_image is not None:
            ...
            right_image = right_image.astype(np.float32)
        return left_image, right_image, p2, p3, labels, image_gt, lidar, road_map
...
class Resize(object):
    ...
    def __call__(self, left_image, right_image=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None, road_map=None):
        ...
        if road_map is not None:
            road_map = cv2.resize(road_map, (w, h), cv2.INTER_NEAREST)
        ...
        if len(self.size) > 1:
            ...
            if left_image.shape[1] > self.size[1]:
                ...
                if road_map is not None:
                    road_map = road_map[:, 0:self.size[1]]
            ...
            # pad out
                ...
                if road_map is not None:
                    if len(road_map.shape) == 2:
                        road_map = np.pad(road_map, [(0, 0), (0, padW)], 'constant')
                    else:
                        road_map = np.pad(road_map, [(0, 0), (0, padW), (0, 0)], 'constant')
...
class CropTop(object):
    ...
    def __call__(self, left_image, right_image=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None, road_map=None):
        ...
        # modify road_map. First scale road_map to image shape, then crop it.
        if road_map is not None:
            road_map = cv2.resize(road_map, (width, height), cv2.INTER_NEAREST)
            road_map = road_map[upper:lower]
...
class FilterObject(object):
    ...
    def __call__(self, left_image, right_image=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None, road_map=None):
        ...
        return left_image, right_image, p2, p3, new_labels, image_gt, lidar, road_map
...
class RandomMirror(object):
    ...
    def __call__(self, left_image, right_image=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None, road_map=None):
        ...
        if random.rand() <= self.mirror_prob:
            ...
            if road_map is not None:
                road_map = road_map[:, ::-1]
                road_map = np.ascontiguousarray(road_map)
...
class PhotometricDistort(object):
    ...
    def __call__(self, left_image, right_image=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None, road_map=None):
        ...
        return distortion(left_image.copy(), right_image if right_image is None else right_image.copy(), p2, p3, labels, image_gt, lidar, road_map)
...
class Augmentation(object):
    ...
    def __call__(self, left_image, right_image, p2=None, p3=None, labels=None, image_gt=None, lidar=None, road_map=None):
        return self.augment(left_image, right_image, p2, p3, labels, image_gt, lidar, road_map)
...
class Preprocess(object):
    ...
    def __call__(self, left_image, right_image, p2=None, p3=None, labels=None, image_gt=None, lidar=None, road_map=None):
        ...
        left_image, right_image, p2, p3, labels, image_gt, lidar, road_map = self.preprocess(left_image, right_image, p2, p3, labels, image_gt, lidar, road_map)
...
class Shuffle(object):
    ...
    def __call__(self, left_image, right_image=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None, road_map=None):
        ...
        for index in shuffled_indexes:
            left_image, right_image, p2, p3, labels, image_gt, lidar, road_map = self.transforms[index](left_image, right_image, p2, p3, labels, image_gt, lidar, road_map)
