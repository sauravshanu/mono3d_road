...
class KittiData:
    ...
    def __init__(self, root_dir, idx, output_dict=None):
        ...
        self.road_map_path = os.path.join(root_dir, "road_map", idx+'.npy')
    ...
    def read_road_map(self):
        return np.load(self.road_map_path)
    ...
    def read_data(self):
        ...
        road_map = self.read_road_map() if self.output_dict["road_map"] else None
