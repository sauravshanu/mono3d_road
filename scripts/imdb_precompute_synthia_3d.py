...
def read_one_split(cfg, index_names, data_root_dir, output_dict, data_split = 'training', time_display_inter=100):
    ...
    for i, placeholder_path in enumerate(index_names):

        # import pdb
        # pdb.set_trace()
        # read data with dataloader api
        data_frame = SynthiaData(data_root_dir, placeholder_path, output_dict)
